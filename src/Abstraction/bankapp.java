...
abstract class Account
{
	...
	abstract void AmountDeposit(double Amount);
	
	
	abstract void AmountWithdraw(double Amount);
...
public class bankapp {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------------------------");
		Account SA = new SavingsAccount(1234,"Hema",10000.0);
		SA.BalanceEnquiry();
		SA.AmountDeposit(10000);
		SA.AmountWithdraw(5000);
		
		Account LA = new LoanAccount(5678,"varshan",500000.0);
		LA.BalanceEnquiry();
		LA.AmountDeposit(0);
		LA.AmountWithdraw(0);
